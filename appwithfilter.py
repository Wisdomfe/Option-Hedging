...
# Grafico 1 come nella versione originale:
# - BAR CHART denso (una barra per strike)
# - Call e Put sovrapposte sullo stesso strike (nessun offset)
# - BS calcolato con σ storica (non IV strike-specifica)
# - Market calcolato con mid-price
# - Solo linea orizzontale a 0 e linea verticale S0

df_plot = A["df"].copy()

# Ricostruisco le differenze usando σ storica
S0 = float(A["S0"])
T = float(A["T"])
